...
public interface A1TicketRepository extends CrudRepository<A1Ticket, Long> {
	...
	@Query("from A1Ticket t  where  :recipient member of t.recipients order by created_on desc ")
	public List<A1Ticket> findByRecipients(@Param("recipient") Staff recipient );
