								...
								<div class="panel-body">
									<div class="form-group input-group">
										<span class="input-group-addon"><i
											class="fa fa-circle-o-notch glyphicon glyphicon-user"></i></span> <input
											type="text" class="form-control" placeholder="Name">
									</div>

									<div class="form-group input-group fuelux">
										<span class="input-group-addon"><i
											class="fa fa-calendar-o"></i></span> <input id="dob" type="text"
						...
						<div class="col-md-5 col-sm-12">
							...
							<div class="panel panel-warning">
								...
								<div class="panel-body">
									...
									<div class="form-group input-group">
										<span class="input-group-addon"><i
											class="fa fa-calendar"></i></span> <input id="join_on" type="text"
											class="form-control" placeholder="Join on">
									</div>
