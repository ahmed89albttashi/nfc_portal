	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong> <spring:message code="a.it_ticket.my_tickets" />
					...
					<table role="tabled" class="table table-striped table-hover"
						...
						<c:forEach items="${tickets}" var="ticket">
							...
							<tr>
								...
								<td><a href="./a/itTicket/track/${ticket.getA1_ticket_ticket_id() }/">${ticket.getTitle()} </a></td>
								<td><spring:message
								...
								<td>FNA</td>
								<td><h5><small> ${fn:substring(ticket.getCreated_on().toString(), 0,16)} </small></h5></td>
